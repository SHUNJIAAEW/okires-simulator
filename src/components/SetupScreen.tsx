...
const styles: Record<string, React.CSSProperties> = {
  ...
  levelBtn: { flex: 1, padding: '8px 4px', border: '2px solid #e2e8f0', borderRadius: 8, background: '#f8fafc', cursor: 'pointer', fontWeight: 600, color: '#64748b', transition: 'all 0.2s' },
  levelBtnActive: { background: '#3b82f6', borderColor: '#3b82f6', color: '#fff' },
  levelBtnGreen: { background: '#22c55e', borderColor: '#22c55e', color: '#fff' },
  monthGrid: { display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 8 },
  monthBtn: { padding: '8px 4px', border: '2px solid #e2e8f0', borderRadius: 8, background: '#f8fafc', cursor: 'pointer', fontSize: 13, fontWeight: 600, color: '#64748b' },
  monthBtnActive: { background: '#f97316', borderColor: '#f97316', color: '#fff' },
  monthBtnDanger: { borderColor: '#fca5a5', background: '#fff7f7' },
