...
// ===== 観光客数 (月別・マニュアルver4.0) =====
// 1月5 / 2月5 / 3月9 / 4月7 / 5月8 / 6月7 / 7月10 / 8月12 / 9月8 / 10月7 / 11月6 / 12月5
export const TOURIST_BY_MONTH: Record<number, number> = {
  1: 5, 2: 5, 3: 9, 4: 7, 5: 8,
  6: 7, 7: 10, 8: 12, 9: 8, 10: 7,
  11: 6, 12: 5,
};

// ===== 観光客 島別上限（ver4.0: 合計最大12＝8月。毎回ランダム配置。月で総数が変わる） =====
// 配置先は 西表島1・竹富島1（＝竹富町2）・石垣島5・宮古島5 のみ。与那国島・波照間島には配置しない。
